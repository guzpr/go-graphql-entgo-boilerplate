...
func (uc *UserCreate) SetOnboardingStatus(as appuser.OnboardingStatus) *UserCreate {
	uc.mutation.SetOnboardingStatus(as)
	return uc
}
...
func (uc *UserCreate) SetGoogleAuthID(id string) *UserCreate {
	uc.mutation.SetGoogleAuthID(id)
	return uc
}

// SetNillableGoogleAuthID sets the "google_auth" edge to the GoogleAuth entity by ID if the given value is not nil.
func (uc *UserCreate) SetNillableGoogleAuthID(id *string) *UserCreate {
	if id != nil {
		uc = uc.SetGoogleAuthID(*id)
	}
	return uc
}

// SetGoogleAuth sets the "google_auth" edge to the GoogleAuth entity.
func (uc *UserCreate) SetGoogleAuth(g *GoogleAuth) *UserCreate {
	return uc.SetGoogleAuthID(g.ID)
}
...
func (uc *UserCreate) check() error {
	...
	if _, ok := uc.mutation.OnboardingStatus(); !ok {
		return &ValidationError{Name: "onboarding_status", err: errors.New(`gen: missing required field "User.onboarding_status"`)}
	}
